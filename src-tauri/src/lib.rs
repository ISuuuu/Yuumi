...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            parsers::summoner::get_champion_mastery_list,
            ...
            tools::get_player_challenges,
            tools::set_player_preferences,
            ...
            commands::lcu::get_liveclient_playerlist,
            commands::lcu::get_liveclient_active_player_name,
            commands::tools::fetch_github_text,
            commands::tools::get_release_changelog,
            commands::tools::write_frontend_log,
